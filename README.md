...
5. **Apply label taxonomy** — the taxonomy ships in Foundation only, as `.github/labels.yml` (§12). Apply it to all three repos with a label-sync action or `gh label create`; Domain and Leadership have no `labels.yml` of their own.
